...
import {indentCommit} from 'release-please/build/src/util/indent-commit';

// Generic
import {Changelog} from 'release-please/build/src/updaters/changelog';

// RubyYoshi
import {VersionRB} from 'release-please/build/src/updaters/ruby/version-rb';
import {
  BaseStrategy,
  BuildUpdatesOptions,
  BaseStrategyOptions,
} from 'release-please/build/src/strategies/base';
import {ConventionalCommit, Commit} from 'release-please/build/src/commit';
  ...
  constructor(options: BaseStrategyOptions) {
    super({
      ...
      commitPartial: readFileSync(
        resolve(
          __dirname,
          'release-please/build/src/../../templates/commit.hbs'
        ),
        'utf8'
      ),
      headerPartial: readFileSync(
        resolve(
          __dirname,
          'release-please/build/src/../../templates/header.hbs'
        ),
        'utf8'
      ),
      mainTemplate: readFileSync(
        resolve(
          __dirname,
          'release-please/build/src/../../templates/template.hbs'
        ),
        'utf8'
      ),
      tagSeparator: '/',
